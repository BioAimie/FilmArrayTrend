...
# Parition data from FilmArray DB from Children's Mercy and CHLA so that there aren't any duplicates
# ============================================================================================
# chla.df[chla.df$Id %in% dat.df$Id, ] - data from CHLA doesn't exist in the Trend data set, only in FA DB
...
# Normalize the data and replace sparse values
# ============================================================================================
...
mf.norm <- data.frame(mf.spread[,1:4], mf.spread[,5:10]/mf.spread$yeastRNA) # fix this because there are some where the max fluor for yeast is super low
dat.df[dat.df$RunDataId==654064, ]  # investigate why this is....
