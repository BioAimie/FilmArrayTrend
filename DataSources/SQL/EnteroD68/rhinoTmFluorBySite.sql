...
WHERE R.[PouchTitle] = 'Respiratory Panel v1.7' AND R.[RunStatus] = 'Completed' AND R.[PositiveAssays] BETWEEN 1 AND 4 AND W.[Result] IN ('Positive','Pass') AND W.[IsHidden] = 0 AND W.[TargetName] = 'Human Rhinovirus/Enterovirus' AND P.[CustomerSiteId] = SITE_INDEX
