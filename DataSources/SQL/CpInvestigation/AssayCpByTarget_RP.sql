...
WHERE R.[PouchTitle] LIKE '%Resp%' AND R.[RunStatus] = 'Completed' AND R.[PositiveAssays] BETWEEN 1 AND 4 AND W.[Result] IN ('Positive','Pass') AND W.[IsHidden] = 0 AND P.[CustomerSiteId] = SITE_INDEX
