...
WHERE r.NoTrend  = 0 and r.SuppressState = 'Trendable' and r.pouchTitle like 'GI%' and r.HasBeenCollected = 1
	and s.CustomerSiteId in (13, 7, 25) and YEAR(r.StartTime) >= 2016
